...
urlpatterns = [
    ...
    path('<int:flat_id>/flats_list_r', views.show_flats_list_r, name="flats_list_r"),
    path('<int:resident_id>/residents_list_r', views.show_residents_list_r, name="residents_list_r"),
    path('remove_resident_m/<int:pk>/', views.ResidentDeleteView.as_view(), name="remove_resident_m"),
    path('edit_resident_m/<int:pk>/', views.ResidentUpdateView.as_view(), name="resident_update_m"),
    path('remove_flat_m/<int:pk>/', views.FlatDeleteView.as_view(), name="remove_flat_m"),
    path('edit_flat_m/<int:pk>/', views.FlatUpdateView.as_view(), name="flat_update_m"),
